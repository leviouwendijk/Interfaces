...
public struct AppointmentAvailabilityPayload: MailerAPIPayload {
    public typealias Variables = MailerAPIAppointmentAvailabilityVariables
    ...
    public init(
            ...
            variables:    MailerAPIAppointmentAvailabilityVariables,
